...
#' @param color 颜色
#' @param varname 变量
#' @param date.form 日期来源
#' @param ... 其他
#' @param week_label 周标签
#' @param month_label 月标签
#'
#' @return 返回值
#' @import lattice
#' @import grid
...
#' @export
#'
#' @examples calendarHeat(bb);
calendarHeat <- function(dates,
                         values,
                         ncolors=99,
                         color="r2g",
                         varname="Values",
                         week_label=c("周日", "周一", "周二", "周三", "周四",
                                      "周五", "周六"),
                         month_label=paste0(1:12,"月"),
                         date.form = "%Y-%m-%d", ...)
{
  #require(lattice)
 # require(grid)
